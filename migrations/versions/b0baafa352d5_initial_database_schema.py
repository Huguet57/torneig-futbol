...
Revision ID: b0baafa352d5
Revises:
Create Date: 2025-03-03 16:00:04.352655
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "type", sa.Enum("group", "elimination", name="phase_type"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("scheduled", "in-progress", "completed", name="match_status"),
            nullable=True,
        ),
        sa.ForeignKeyConstraint(
            ["away_team_id"],
